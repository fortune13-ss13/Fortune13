...
/datum/reagent/medicine/berserker_powder/on_mob_add(mob/living/carbon/human/M)
	..()
	if(isliving(M))
		to_chat(M, "<span class='notice'>The veil breaks, and the heavens spill out! The spirits of the dead float down from the heavens, and the deafening beat of your ancestors wardrums fills your ears. Their ethereal forms are guiding you in battle!</span>")
		M.maxHealth += 20
		M.health += 20
