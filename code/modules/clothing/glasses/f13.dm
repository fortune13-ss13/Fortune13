...
/obj/item/clothing/glasses/legiongoggles
	...
	desc = "Post-war makeshift protective goggles made & utilised mostly by various types of long distance traders and travellers to protect from weather, dust & sand."
	icon_state = "legion"
	item_state = "legion"
