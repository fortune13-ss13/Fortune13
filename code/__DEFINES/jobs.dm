...
#define RAIDERBISHOP	(1<<3)
#define RAIDERSTRONGMAN	(1<<4)
#define RAIDERPSYCHO	(1<<5)
#define RAIDERCHIEFTAIN	(1<<6)
#define RAIDERBERSERKER	(1<<7)
#define RAIDERTRIBAL	(1<<8)
#define F13DENDOCTOR    (1<<9)
#define F13WASTELANDER	(1<<10)
#define EVENTCOVEN		(1<<11)
#define F13VIGILANTE	(1<<12)
#define F13ADMINBOOS	(1<<13)
#define F13CULTLEADER	(1<<14)
