...
/datum/controller/subsystem/monster_wave/proc/spawn_monsterwave()
	var/pick_unfortune = pick("Ghoul", "Deathclaw", "Radscorpion", "YaoGuai", "Fireant", "Molerat", "Mirelurk")
...
/datum/controller/subsystem/monster_wave/proc/wanamingo_wave()
	...
	var/turf/pixel_turf = get_turf_pixel(choose_turf)
	for(var/i in 1 to spawn_amount)
		new /mob/living/simple_animal/hostile/deathclaw/yaoguai(choose_turf)
...
/datum/controller/subsystem/monster_wave/proc/fireant_wave()
	...
	var/turf/pixel_turf = get_turf_pixel(choose_turf)
	for(var/i in 1 to spawn_amount)
		new /mob/living/simple_animal/hostile/giantanteast(choose_turf)
		if(prob(1))
...
/datum/controller/subsystem/monster_wave/proc/mirelurk_wave()
	...
	for(var/i in 1 to spawn_amount)
		...
		if(prob(8))
			new /mob/living/simple_animal/hostile/mirelurk/ancient(choose_turf)
